...
class TaxonomyApiController extends Controller
{
    public function index()
    {
        ...
        return new TaxonomyResource(Taxonomy::with(['parent'])->advancedFilter());
    }
    ...
    public function show(Taxonomy $taxonomy)
    {
        ...
        return new TaxonomyResource($taxonomy->load(['parent']));
    }
    ...
    public function edit(Taxonomy $taxonomy)
    {
        ...
        return response([
            'data' => new TaxonomyResource($taxonomy->load(['parent'])),
            'meta' => [
                'parent' => Taxonomy::get(['id', 'name']),
            ],
        ]);
